...
public class CreateEstateActivity extends AppCompatActivity implements OnMapReadyCallback, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.create_estate_activity);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            case R.id.btn_back:
                ...
                break;
            case R.id.btn_chat:
                intent = new Intent(CreateEstateActivity.this, ChatActivity.class);
