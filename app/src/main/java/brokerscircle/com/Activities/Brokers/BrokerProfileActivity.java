...
import brokerscircle.com.Activities.ProfileFollowersActivity;
...
import brokerscircle.com.fragments.TabsFragments.ProfileTabs.ProfileAboutTabFragment;
import brokerscircle.com.fragments.TabsFragments.ProfileTabs.ProfileFilesTabFragment;
import brokerscircle.com.fragments.TabsFragments.ProfileTabs.ProfileGalleryTabFragment;
import brokerscircle.com.fragments.TabsFragments.ProfileTabs.ProfileListingTab;
import brokerscircle.com.fragments.TabsFragments.ProfileTabs.ProfilePastDealingTabFragment;
import brokerscircle.com.fragments.TabsFragments.ProfileTabs.ProfileReviewTabFragment;
import brokerscircle.com.fragments.TabsFragments.ProfileTabs.ProfileVideosTabFragment;
        ...
        new BrokersDatabaseHelper().readBrokersDetail(new BrokersDatabaseHelper.DataStatus() {
            ...
            public void DataIsLoaded(List<BrokersData> brokersUtils) {
                if (brokersUtils.isEmpty()){
                    ...
                    }, BrokerProfileActivity.this,brokerid, user.getResponse().getData().getUser().getUserId(),"UserToBroker");
