...
import brokerscircle.com.model.Owner.OnwerUtil;
import brokerscircle.com.model.Owner.OwnerData;
import brokerscircle.com.services.VolleyService;

public class OwnerDatabaseHelper {

    private String TAG = "OwnerDatabaseHelper";
    private static final String ALL_OWNER = Constant.BASE_URL+"owners/list?app_id="+Constant.APP_ID+"&app_key="+Constant.APP_KEY;
