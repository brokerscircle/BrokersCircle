...
import brokerscircle.com.model.Brokers.BrokersUtils;
...
public class BrokersDatabaseHelper {
    ...
    private static final String BROKERS_URL = Constant.BASE_URL+"brokers/list?app_id="+Constant.APP_ID+"&app_key="+Constant.APP_KEY;
