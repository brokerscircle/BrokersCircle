...
import brokerscircle.com.model.Videos.VideosUtil;
import brokerscircle.com.services.VolleyService;

public class VideosDatabaseHelper {

    private String TAG = "VideosDatabaseHelper";
    private static final String Videos_LIST = Constant.BASE_URL+"videos/list?app_id="+ Constant.APP_ID+"&app_key="+Constant.APP_KEY;
