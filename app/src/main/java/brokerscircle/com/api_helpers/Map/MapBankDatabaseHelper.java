...
import brokerscircle.com.model.Map.MapBank.MapsBankUtil;
...
public class MapBankDatabaseHelper {
    ...
    private static final String ALL_MAPS = Constant.BASE_URL+"map-banks/list?app_id="+Constant.APP_ID+"&app_key="+Constant.APP_KEY;
