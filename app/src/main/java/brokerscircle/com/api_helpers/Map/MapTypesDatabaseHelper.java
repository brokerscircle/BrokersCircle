package brokerscircle.com.api_helpers.Map;
...
import brokerscircle.com.model.Map.MapTypes.MapTypesUtil;
...
public class MapTypesDatabaseHelper {
    ...
    private static final String ALL_MAPS = Constant.BASE_URL+"map-types/list?app_id="+Constant.APP_ID+"&app_key="+Constant.APP_KEY;
