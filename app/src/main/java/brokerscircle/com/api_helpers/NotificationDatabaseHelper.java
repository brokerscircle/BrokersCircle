...
import brokerscircle.com.model.Notification.NotificationUtil;
...
public class NotificationDatabaseHelper {
    ...
    private static final String NOTIFICATION_URL = Constant.BASE_URL+"notifications/list?app_id="+ Constant.APP_ID+"&app_key="+Constant.APP_KEY;
    //Volley services
