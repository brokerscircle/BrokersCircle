...
import brokerscircle.com.model.News.NewsUtils;
import brokerscircle.com.services.VolleyService;

public class NewsDatabaseHelper {

    private String TAG = "BrokersDatabaseHelper";
    private static final String ALL_NEWS_LIST = Constant.BASE_URL+"blog/list?app_id="+ Constant.APP_ID+"&app_key="+Constant.APP_KEY;
