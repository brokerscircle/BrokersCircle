...
import brokerscircle.com.model.MasterAPI.MasterData;
import brokerscircle.com.model.MasterAPI.MasterUtil;
import brokerscircle.com.services.VolleyService;

public class MasterDatabaseHelper {

    private String TAG = "MasterDatabaseHelper";
    private static final String MASTER_URL = Constant.BASE_URL+"user-and-user-type-master/list?app_id="+ Constant.APP_ID+"&app_key="+Constant.APP_KEY;
    //Volley services
