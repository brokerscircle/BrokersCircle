...
import brokerscircle.com.model.PhoneCountryCode.PhoneCountryCodeUtil;
...
public class PhoneCountryCodeAPIHelper {
    ...
    private static final String PHONE_CODE_URL = Constant.BASE_URL+"country-code/list?app_id="+ Constant.APP_ID+"&app_key="+Constant.APP_KEY;
