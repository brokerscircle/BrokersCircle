...
import brokerscircle.com.model.RealEstates.RealEstateUtils;
...
public class RealEstateDatabaseHelper {
    ...
    private static final String ESTATES_URL = Constant.BASE_URL+"companies/list?app_id="+Constant.APP_ID+"&app_key="+Constant.APP_KEY;
