...
import brokerscircle.com.model.Users.UsersUtil;
import brokerscircle.com.services.VolleyService;

public class UsersDatabaseHelper {

    private String TAG = "UsersDatabaseHelper";
    private static final String ALL_USERS_LIST = Constant.BASE_URL+"users/list?app_id="+ Constant.APP_ID+"&app_key="+Constant.APP_KEY;
    //Volley services
