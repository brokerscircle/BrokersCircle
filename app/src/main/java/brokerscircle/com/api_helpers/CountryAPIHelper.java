...
import brokerscircle.com.model.Country.CountryUtil;
...
public class CountryAPIHelper {
    ...
    private static final String COUNTRY_URL = Constant.BASE_URL+"countries/list?app_id="+ Constant.APP_ID+"&app_key="+Constant.APP_KEY;
