...
import brokerscircle.com.model.Files.FilesUtil;
import brokerscircle.com.services.VolleyService;

public class FilesDatabaseHelper {

    private String TAG = "FilesDatabaseHelper";
    private static final String Files_LIST = Constant.BASE_URL+"files/list?app_id="+ Constant.APP_ID+"&app_key="+Constant.APP_KEY;
