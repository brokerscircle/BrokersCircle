...
import brokerscircle.com.model.Phone.PhoneUtils;
import brokerscircle.com.services.VolleyService;

public class PhoneDatabaseHelper {

    private String TAG = "PhoneDatabaseHelper";
    private static final String PHONE_DETAIL = Constant.BASE_URL+"phones/list?app_id="+ Constant.APP_ID+"&app_key="+Constant.APP_KEY+"&reference_id=";
