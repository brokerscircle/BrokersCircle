...
import brokerscircle.com.model.Developers.DeveloperBrokers.DeveloperBrokersData;
import brokerscircle.com.model.Developers.DeveloperBrokers.DeveloperBrokersUtil;
...
public class DeveloperBrokerDatabaseHepler {
    ...
    private static final String DEVELOPER_BROKER = Constant.BASE_URL+"developer-brokers/list?app_id="+Constant.APP_ID+"&app_key="+Constant.APP_KEY+"&developer_id=";
