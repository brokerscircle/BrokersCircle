...
/*
* This class includes methods to implement basic SQLite database and table operations, such as open database,
        close database, insert data, update data, delete data and query data.
* */
