...
public class PropertyListRecyclerview_config_Two {
    ...
    class PropertyItemView extends RecyclerView.ViewHolder{
        ...
        private TextView mEstateName, mDescription, mAddress, mName, mTime;
        ...
        public PropertyItemView( ViewGroup parent) {
            super(LayoutInflater.from(mContext).
                    inflate(R.layout.property_item_row_single_two, parent, false));
...
//                        }
                    ...
                    if ((propertyData.getDescription() == null) || (propertyData.getDescription().equals(""))){
                        ...
                        mDescription.setText(propertyData.getTitle());
                    }
