package brokerscircle.com.model.Developers.DeveloperBrokers;

import com.google.gson.annotations.Expose;
import com.google.gson.annotations.SerializedName;

public class DeveloperBrokersData {
    @SerializedName("id")
    @Expose
    private String id;
    @SerializedName("property_developer_id")
    @Expose
    private String propertyDeveloperId;
    ...
    public String getPropertyDeveloperId() {
        return propertyDeveloperId;
    }

    public void setPropertyDeveloperId(String propertyDeveloperId) {
