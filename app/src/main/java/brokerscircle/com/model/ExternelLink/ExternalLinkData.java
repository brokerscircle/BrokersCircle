...
public class ExternalLinkData {
    ...
    @Expose
    private String id;
    @SerializedName("external_link_type_id")
    @Expose
    private String externalLinkTypeId;
    @SerializedName("external_link_type_title")
    @Expose
    private String externalLinkTypeTitle;
    ...
    public String getExternalLinkTypeId() {
        return externalLinkTypeId;
    }

    public void setExternalLinkTypeId(String externalLinkTypeId) {
        this.externalLinkTypeId = externalLinkTypeId;
    }

    public String getExternalLinkTypeTitle() {
        return externalLinkTypeTitle;
    }

    public void setExternalLinkTypeTitle(String externalLinkTypeTitle) {
        this.externalLinkTypeTitle = externalLinkTypeTitle;
    }
