package brokerscirlce.com.fragments.TabsFragments.Dashboard.DashboardOneTabs;
...
public class D1BuyTapFragment extends Fragment {

    private RecyclerView mRecyclerview;

    public D1BuyTapFragment() {
        // Required empty public constructor
    }

    public static D1BuyTapFragment newInstance(String param1, String param2) {
        D1BuyTapFragment fragment = new D1BuyTapFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.d1_buy_tab_fragment, container, false);

        mRecyclerview = view.findViewById(R.id.recycle_buy_property);
