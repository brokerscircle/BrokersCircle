...
public class NewsAndInfoFragment extends Fragment implements PullRefreshLayout.OnRefreshListener, View.OnClickListener {
    ...
    public NewsAndInfoFragment() {
        // Required empty public constructor
    }


    public static NewsAndInfoFragment newInstance(String param1, String param2) {
        NewsAndInfoFragment fragment = new NewsAndInfoFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.news_and_info_fragment, container, false);
