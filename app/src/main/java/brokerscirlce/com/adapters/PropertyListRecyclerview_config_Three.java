...
public class PropertyListRecyclerview_config_Three {
    ...
    class PropertyItemView extends RecyclerView.ViewHolder{
        ...
        private TextView mEstateName, mTitle, mAddress, mName, mTime;
        ...
        public PropertyItemView( ViewGroup parent) {
            super(LayoutInflater.from(mContext).
                    inflate(R.layout.property_item_row_single_three, parent, false));
