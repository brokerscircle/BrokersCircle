...
public class SearchEstateActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.search_estate_activity);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            case R.id.btn_back:
                ...
                break;
            case R.id.btn_chat:
                intent = new Intent(SearchEstateActivity.this, ChatActivity.class);
            ...
            case R.id.btn_search:
                intent = new Intent(SearchEstateActivity.this, ViewAllEstateActivity.class);
                startActivity(intent);
                break;
        }
    }
