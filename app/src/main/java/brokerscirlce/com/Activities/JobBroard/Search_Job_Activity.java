package brokerscirlce.com.Activities.JobBroard;
...
public class Search_Job_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private LinearLayout postjobtv;
    ...
    private void initContents() {
        ...
        postjobtv.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            case R.id.btn_back:
                ...
                break;
            case R.id.btn_chat:
                intent = new Intent(Search_Job_Activity.this, ChatActivity.class);
...
//                intent = new Intent(Search_Job_Activity.this, Search_Job_Activity.class);
//                startActivity(intent);

                Toast.makeText(this, "Coming soon", Toast.LENGTH_SHORT).show();
                break;
            case R.id.postjobtv:
                intent = new Intent(Search_Job_Activity.this, CreateJobsActivity.class);
                startActivity(intent);
                break;
        }
    }
