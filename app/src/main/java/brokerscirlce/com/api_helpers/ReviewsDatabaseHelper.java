...
import brokerscirlce.com.model.Reviews.ReviewUtils;
...
public class ReviewsDatabaseHelper {
    ...
    private static final String REVIEWS_LIST = Constant.BASE_URL+"api/ratings/list?app_id="+Constant.APP_ID+"&app_key="+Constant.APP_KEY;
