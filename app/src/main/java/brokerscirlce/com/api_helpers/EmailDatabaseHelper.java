...
import brokerscirlce.com.model.Email.EmailData;
import brokerscirlce.com.model.Email.EmailUtil;
import brokerscirlce.com.services.VolleyService;

public class EmailDatabaseHelper {

    private String TAG = "EmailDatabaseHelper";
    private static final String EMAIL_LIST = Constant.BASE_URL+"api/emails/list?app_id="+ Constant.APP_ID+"&app_key="+Constant.APP_KEY;
