...
import brokerscirlce.com.model.City.CityUtil;
...
public class CityAPIHelper {
    ...
    private static final String CITY_URL = Constant.BASE_URL+"api/cities/list?app_id="+ Constant.APP_ID+"&app_key="+Constant.APP_KEY;
