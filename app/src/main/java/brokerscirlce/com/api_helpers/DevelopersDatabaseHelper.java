...
import brokerscirlce.com.model.Developers.DevelopersUtils;
...
public class DevelopersDatabaseHelper {
    ...
    private static final String DEVELOPERS_URL = Constant.BASE_URL+"api/developers/list?app_id="+ Constant.APP_ID +"&app_key="+Constant.APP_KEY;
