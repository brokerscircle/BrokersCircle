...
import brokerscirlce.com.model.Project.ProjectUtil;
...
public class ProjectDatabaseHelper {
    ...
    private static final String PROJECT_URL = Constant.BASE_URL+"api/projects/list?app_id="+ Constant.APP_ID+"&app_key="+Constant.APP_KEY;
