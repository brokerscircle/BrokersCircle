...
import brokerscirlce.com.model.ExternelLink.ExternelLinkUtil;
...
public class ExternalLinkDatabaseHelper {
    ...
    private static final String EXTERNAL_LINK_LIST = Constant.BASE_URL+"api/external-link/list?app_id="+ Constant.APP_ID+"&app_key="+Constant.APP_KEY;
