...
import brokerscirlce.com.model.Units.UnitsUtil;
...
public class UnitApiHelper {
    ...
    private static final String URL = Constant.BASE_URL+"api/units/list?app_id="+ Constant.APP_ID+"&app_key="+Constant.APP_KEY;
