...
import brokerscirlce.com.model.PastDealing.PastDealingUtils;
...
public class PastDealingDatabaseHelper {
    ...
    private static final String PASTDEALING_URL = Constant.BASE_URL+"api/broker-to-broker-dealings/list?app_id="+Constant.APP_ID+"&app_key="+Constant.APP_KEY;
