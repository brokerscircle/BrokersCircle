...
import brokerscirlce.com.model.Province.ProvinceUtil;
...
public class ProvinceAPIHelper {
    ...
    private static final String PROVINCE_URL = Constant.BASE_URL+"api/provinces/list?app_id="+ Constant.APP_ID+"&app_key="+Constant.APP_KEY;
