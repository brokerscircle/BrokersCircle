...
import brokerscirlce.com.model.Currency.CurrencyUtil;
...
public class CurrencyApiHelper {
    ...
    private static final String URL = Constant.BASE_URL+"api/currencies/list?app_id="+ Constant.APP_ID+"&app_key="+Constant.APP_KEY;
