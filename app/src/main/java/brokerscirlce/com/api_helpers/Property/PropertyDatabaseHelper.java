...
import brokerscirlce.com.model.Property.PropertyUtil;
...
public class PropertyDatabaseHelper {
    ...
    private static final String PROPERTIES_URL = Constant.BASE_URL+"api/properties/list?app_id="+ Constant.APP_ID+"&app_key="+Constant.APP_KEY;
