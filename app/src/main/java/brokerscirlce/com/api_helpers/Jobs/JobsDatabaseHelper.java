package brokerscirlce.com.api_helpers.Jobs;
...
import brokerscirlce.com.model.jobs.JobUtils;
...
public class JobsDatabaseHelper {
    ...
    private static final String JOBS_URL = Constant.BASE_URL+"api/jobs/list?app_id="+ Constant.APP_ID+"&app_key="+Constant.APP_KEY;
