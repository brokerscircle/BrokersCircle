...
public class FollowersDatabaseHelper {
    ...
    private static final String FOLLOWER_POST_URL = Constant.BASE_URL+"api/general/following?app_id="+ Constant.APP_ID+"&app_key="+Constant.APP_KEY;
    private static final String FOLLOWER_DELETE_URL = Constant.BASE_URL+"api/general/unfollowing?app_id="+ Constant.APP_ID+"&app_key="+Constant.APP_KEY;
    //Volley services
