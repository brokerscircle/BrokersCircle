...
import brokerscirlce.com.model.Addresses.AddressUtil;
...
public class AddressAPIHelper {
    ...
    private static final String ALL_ADDRESS_LIST = Constant.BASE_URL+"api/addresses/list?app_id="+ Constant.APP_ID+"&app_key="+Constant.APP_KEY;
    private static final String SINGLE_ADDRESS_DATA = Constant.BASE_URL+"api/addresses/list?app_id="+ Constant.APP_ID+"&app_key="+Constant.APP_KEY+"&id=";
    private static final String ADDRESS_REF_ID = Constant.BASE_URL+"api/addresses/list?app_id="+ Constant.APP_ID+"&app_key="+Constant.APP_KEY+"&reference_id=";
    private static final String ADDRESS_REF_TYPE = Constant.BASE_URL+"api/addresses/list?app_id="+ Constant.APP_ID+"&app_key="+Constant.APP_KEY+"&reference_type=";
    private static final String ADDRESS_Verified = Constant.BASE_URL+"api/addresses/list?app_id="+ Constant.APP_ID+"&app_key="+Constant.APP_KEY+"&verification_status=Verified";
