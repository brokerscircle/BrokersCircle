...
import brokerscirlce.com.model.Galleries.GalleriesUtil;
...
public class GalleriesDatabaseHelper {
    ...
    private static final String GALLERIES_LIST = Constant.BASE_URL+"api/galleries/list?app_id="+ Constant.APP_ID+"&app_key="+Constant.APP_KEY;
