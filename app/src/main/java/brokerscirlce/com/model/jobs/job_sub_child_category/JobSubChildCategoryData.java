package brokerscirlce.com.model.jobs.job_sub_child_category;

import com.google.gson.annotations.Expose;
import com.google.gson.annotations.SerializedName;

public class JobSubChildCategoryData {
    ...
    @Expose
    private String jobChildCategoryId;
    @SerializedName("job_child_category_title")
    @Expose
    private String jobChildCategoryTitle;
    ...
    public String getJobChildCategoryId() {
        return jobChildCategoryId;
    }

    public void setJobChildCategoryId(String jobChildCategoryId) {
        this.jobChildCategoryId = jobChildCategoryId;
    }

    public String getJobChildCategoryTitle() {
        return jobChildCategoryTitle;
    }

    public void setJobChildCategoryTitle(String jobChildCategoryTitle) {
        this.jobChildCategoryTitle = jobChildCategoryTitle;
    }
