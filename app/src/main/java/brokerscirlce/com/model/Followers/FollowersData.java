package brokerscirlce.com.model.Followers;
...
public class FollowersData {
    ...
    @Expose
    private String id;
    @SerializedName("followed_from_id")
    @Expose
    private String followedFromId;
    @SerializedName("followed_to_id")
    @Expose
    private String followedToId;
    @SerializedName("followed_type")
    @Expose
    ...
    public String getFollowedFromId() {
        return followedFromId;
    }

    public void setFollowedFromId(String followedFromId) {
        this.followedFromId = followedFromId;
    }
